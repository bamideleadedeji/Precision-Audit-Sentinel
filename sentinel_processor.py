...
class UniversalSentinelEngine:
    ...
    def process_transaction_ledger(self, file_target):
        ...
        # Strip out quotes, commas, and formatting from Debit and Credit columns
        ...
        # Combine Debit and Credit into a single absolute numeric transaction amount
        df_raw['amount'] = df_raw['Debit'] + df_raw['Credit']

        # Map the bank's 'Transaction Date' directly to the output 'timestamp' field
        ...
        # Initialize default values for missing schema parameters
        ...
        if 'Narration' in df_raw.columns:
            ...
            # Advanced Risk Rule Gamma (Flagging transaction fees, OTP, and stamp duties)
        ...
        # High-Value Risk Isolation Threshold (Over ₦100,000)
        ...
        # Sort and write the clean parsed data structure to file
